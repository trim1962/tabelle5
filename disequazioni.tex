...
\begin{esempiot}{Delta uguale a zero, a negativa}{}
	...
	\begin{center}
		...
		\captionof{figure}{Delta uguale zero a minore di zero}
	\end{center}\index{Delta uguale zero!a minore di zero}
	Quindi otteniamo
	\begin{center}
...
\begin{esempiot}{Delta minore di zero, a positiva}{}
	...
	\begin{center}
		...
		\captionof{figure}{Delta minore di zero a maggiore di zero}
	\end{center}\index{Delta minore di zero!a maggiore di zero}
	Quindi otteniamo
	\begin{center}
	...
	Fine
\end{esempiot}
\begin{esempiot}{Delta minore di zero, a negativa}{}
	\begin{NodesList}[margin=4.0cm]
		\centering
		\begin{flalign*}
		\quadratic{-1}{3}{-4}<& 0\AddNode&\\[.5cm] 
		\quadratic{-1}{3}{-4}= &0\AddNode&\\[.5cm] %\AddNode[2]\\ 
		x_{1,2}=&\xunodue{-1}{3}{-4}\AddNode&\\
		x_{1,2}=&\xunodueE{-1}{3}{-4}\AddNode&\\
		x_{1,2}=&\xunodueEE{-1}{3}{-4}\AddNode&\\
		\text{Nessuna soluzione}\AddNode&\\
		\end{flalign*}
		\tikzset{LabelStyle/.style = {right=0.1cm,pos=0.5,text=red,fill=white}}
		\LinkNodes{Risolvo l'equazione}
	...
	Quindi il grafico corrispondente è:
	\begin{center}
		\includestandalone{DisGrafici/DeltaMinoreZeroAminoreDizero}
		\captionof{figure}{Delta minore di zero a minore di zero}
	\end{center}\index{Delta minore di zero!a minore di zero}
	Quindi otteniamo
	\begin{center}
		\includestandalone{DisGrafici/DeltaMinoreZeroAminoreDizero1}
	\end{center}
